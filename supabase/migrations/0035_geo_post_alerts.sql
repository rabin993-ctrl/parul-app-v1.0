...
-- Project URL read from Vault (supabase_project_url); token from Vault
-- (edge_function_token / fan_out_alert_token). Migration 0072 re-creates this
-- function with helper wrappers — this initial version uses the same vault
-- pattern inline.
...
BEGIN
  ...
  PERFORM net.http_post(
    url     := v_base || '/functions/v1/fan-out-alert',
