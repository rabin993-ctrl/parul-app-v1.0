...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      circle_invites: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "circle_invites_invitee_user_id_fkey"
          ...
          {
            foreignKeyName: "circle_invites_inviter_user_id_fkey"
      ...
      circle_join_requests: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "circle_join_requests_invited_by_user_id_fkey"
      ...
      circles: {
        ...
        Relationships: [
          {
            foreignKeyName: "circles_avatar_media_id_fkey"
      ...
      companions: {
        ...
        Relationships: [
          {
            foreignKeyName: "companions_avatar_media_id_fkey"
            columns: ["avatar_media_id"]
            isOneToOne: false
            referencedRelation: "media_assets"
            referencedColumns: ["id"]
      ...
      post_alert_deliveries: {
        ...
        Relationships: [
          {
            foreignKeyName: "post_alert_deliveries_post_id_fkey"
            columns: ["post_id"]
            isOneToOne: false
            referencedRelation: "posts"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "post_alert_deliveries_user_id_fkey"
            columns: ["user_id"]
            isOneToOne: false
            referencedRelation: "profile_trust"
            referencedColumns: ["user_id"]
      ...
      posts: {
        Row: {
          ...
          companion_content_style: string | null
          created_at: string
          deleted_at: string | null
      ...
      rescue_help_offers: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "rescue_help_offers_reviewed_by_user_id_fkey"
      ...
      users: {
        ...
        Relationships: [
          {
            foreignKeyName: "users_avatar_media_id_fkey"
            columns: ["avatar_media_id"]
            isOneToOne: false
            referencedRelation: "media_assets"
            referencedColumns: ["id"]
    ...
    Functions: {
      ...
      check_circle_slug: { Args: { p_slug: string }; Returns: Json }
      ...
      fan_out_my_post_alert: { Args: { p_post_id: string }; Returns: Json }
      fan_out_post_alert: { Args: { p_post_id: string }; Returns: Json }
      ...
      get_post_visibility: {
        ...
        Returns: Database["public"]["Enums"]["profile_visibility_enum"]
      }
      ...
      get_show_treats_on_profile: {
        Args: { p_user_id: string }
        Returns: boolean
      }
      get_user_discoverable: { Args: { p_user_id: string }; Returns: boolean }
      get_user_show_companions: {
        Args: { p_user_id: string }
        Returns: boolean
      }
      get_user_show_location: { Args: { p_user_id: string }; Returns: boolean }
      get_user_show_online: { Args: { p_user_id: string }; Returns: boolean }
      ...
      parul_detect_project_api_base: { Args: never; Returns: string }
      parul_edge_function_token: { Args: never; Returns: string }
      parul_edge_function_url: {
        Args: { p_function_name: string }
        Returns: string
      }
      parul_seed_vault_edge_secrets: { Args: never; Returns: undefined }
      parul_set_edge_function_token: {
        Args: { p_token: string }
        Returns: undefined
      }
      ...
      resolve_post_alert: { Args: { p_post_id: string }; Returns: undefined }
      save_post_alert: {
        Args: {
          p_area?: string
          p_found_at?: string
          p_kind: Database["public"]["Enums"]["alert_kind_enum"]
          p_last_seen?: string
          p_lat?: number
          p_lng?: number
          p_looks_like?: string
      ...
      seed_rescue_help_intro: {
        Args: { p_intro_text: string; p_thread_id: string }
        Returns: undefined
      }
      seed_rescue_help_offer_message: {
        Args: {
          p_case_id: string
      ...
      send_circle_invite: {
        Args: { p_circle_id: string; p_invitee_user_id: string }
        Returns: string
      }
      send_circle_request: {
      ...
      soft_delete_companion: { Args: { p_companion_id: string }; Returns: Json }
      soft_delete_post: { Args: { p_post_id: string }; Returns: Json }
      ...
      update_community_settings: {
        Args: {
          ...
          p_default_category?: Database["public"]["Enums"]["community_category_enum"]
          p_discoverable?: boolean
          p_enabled_topics?: Database["public"]["Enums"]["community_category_enum"][]
          p_guidelines?: string[]
          p_icon?: string
          p_join_policy?: Database["public"]["Enums"]["join_policy_enum"]
          p_members_only?: boolean
          ...
          p_require_photo_lost_found?: boolean
